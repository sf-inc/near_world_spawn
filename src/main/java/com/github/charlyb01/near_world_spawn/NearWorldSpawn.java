        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> {
            ...
            dispatcher.register(CommandManager.literal("worldspawn")
                    ...
                    .then(CommandManager.literal("circle")
                            .then(CommandManager.argument("expand", IntegerArgumentType.integer(0))
                                    .then(CommandManager.literal("none")
                                            .executes(context -> Utils.setShapeInfluenceAndExpand(AreaShape.CIRCLE, PlayerInfluence.NONE, IntegerArgumentType.getInteger(context, "expand"), context)))
                                    .then(CommandManager.literal("area_offset")
                                            .executes(context -> Utils.setShapeInfluenceAndExpand(AreaShape.CIRCLE, PlayerInfluence.AREA_OFFSET, IntegerArgumentType.getInteger(context, "expand"), context)))
                                    .then(CommandManager.literal("area_shrink")
                                            .executes(context -> Utils.setShapeInfluenceAndExpand(AreaShape.CIRCLE, PlayerInfluence.AREA_SHRINK, IntegerArgumentType.getInteger(context, "expand"), context)))))
            );
            dispatcher.register(CommandManager.literal("worldspawn-areashape")
                    ...
                    .then(CommandManager.literal("circle")
                            .executes(context -> Utils.setAreaShape(AreaShape.CIRCLE, context)))
            );
